...
const ESTUDOS_FIXOS = [
  // ══ INICIANTES ══
  {
    ...
    titulo: "O que é a Salvação?",
    versiculo: "Efésios 2:8-9 — \"Porque pela graça sois salvos, mediante a fé; e isto não vem de vós, é dom de Deus. Não vem das obras, para que ninguém se glorie.\"",
    texto: "Salvação é uma das palavras mais usadas — e menos compreendidas — no meio cristão. Afinal, salvos de quê, e para quê?\n\n**O problema: estamos separados de Deus**\n\nA Bíblia ensina que 'todos pecaram e destituídos estão da glória de Deus' (Romanos 3:23). O pecado não é apenas quebrar regras — é uma condição que nos separa da presença santa de Deus. Como consequência, Romanos 6:23 afirma que 'o salário do pecado é a morte'. Não somos pessoas basicamente boas que cometem alguns erros; somos pessoas que precisam ser resgatadas.\n\n**A solução: Jesus tomou nosso lugar**\n\nA boa notícia é que Deus não ficou distante do nosso problema. 'Mas Deus prova o seu amor para conosco, em que Cristo morreu por nós, sendo nós ainda pecadores' (Romanos 5:8). Jesus, sendo perfeito, morreu na cruz carregando a pena que deveríamos pagar. Ele não morreu apenas por 'a humanidade' de forma genérica — Ele morreu por você, especificamente.\n\n**Como recebemos a salvação**\n\nA salvação não se ganha com esforço, boas obras ou religiosidade. Ela é recebida pela fé — confiar que a morte e ressurreição de Jesus são suficientes para nos reconciliar com Deus. 'Se, com a tua boca, confessares a Jesus como Senhor e, em teu coração, creres que Deus o ressuscitou dentre os mortos, será salvo' (Romanos 10:9). É simples o suficiente para uma criança entender, e profundo o bastante para mudar toda uma vida.\n\n**Salvação não é apenas um evento, é uma vida nova**\n\nSer salvo não é apenas escapar de uma punição futura — é começar uma vida nova agora. 'Assim que, se alguém está em Cristo, nova criatura é' (2 Coríntios 5:17). A salvação inclui um novo relacionamento com Deus, um novo propósito de vida e a presença do Espírito Santo habitando em nós.\n\n**A certeza da salvação**\n\nMuitos cristãos vivem com dúvida sobre sua salvação, mas a Bíblia oferece certeza, não ansiedade. 'Estas coisas vos escrevi, a vós que credes no nome do Filho de Deus, para que saibais que tendes a vida eterna' (1 João 5:13). A certeza não está em sentimentos que oscilam, mas na promessa fiel de Deus.",
    referencias: [
      "Romanos 3:23 — Todos pecaram e destituídos estão da glória de Deus",
      "Romanos 6:23 — O salário do pecado é a morte, mas o dom de Deus é a vida eterna",
      ...
      "1 João 5:11-13 — Podemos saber que temos a vida eterna",
    ],
    perguntas: [
      "Antes de conhecer Jesus, como você entendia a ideia de 'ser uma pessoa boa o suficiente' para Deus?",
      "O que significa, na prática, confiar na graça de Deus em vez de tentar merecê-la?",
      "De que forma sua vida mudou (ou pode mudar) depois de receber a salvação?",
      "Você vive com certeza da sua salvação, ou com dúvida? O que a Palavra de Deus diz sobre isso?",
    ],
    oracao: "Senhor, obrigado porque a salvação não depende do meu esforço, mas da Tua graça. Reconheço que preciso de Ti e creio que Jesus morreu e ressuscitou por mim. Obrigado pela vida nova que recebo em Cristo. Que eu viva com a certeza de que sou Teu filho, hoje e para sempre. Amém."
  },
  {
    id: "f2", nivel: "iniciante", fixo: true,
    titulo: "O Batismo nas Águas",
    versiculo: "Romanos 6:4 — \"Fomos, pois, sepultados com ele pelo batismo na morte, para que, como Cristo foi ressuscitado dentre os mortos pela glória do Pai, assim também andemos nós em novidade de vida.\"",
    texto: "Depois de receber a salvação, um dos primeiros passos de obediência que a Bíblia ensina é o batismo nas águas. Mas o que ele realmente significa?\n\n**O que é o batismo**\n\nA palavra 'batizar' vem do grego 'baptizo', que significa mergulhar ou imergir. O batismo é um ato público em que o novo crente é imerso na água e depois levantado, simbolizando algo profundo que já aconteceu em seu espírito.\n\n**O exemplo de Jesus**\n\nMesmo sem pecado, Jesus foi batizado por João Batista para 'cumprir toda justiça' (Mateus 3:15), dando o exemplo aos Seus seguidores. Se o próprio Filho de Deus se submeteu ao batismo, quanto mais nós devemos segui-Lo nesse passo de obediência.\n\n**O significado do batismo**\n\nO batismo representa três verdades poderosas. Primeiro, identificação com a morte de Cristo — ao ser mergulhado na água, declaramos que nossa velha vida morreu com Cristo. Segundo, identificação com Sua ressurreição — ao sair da água, declaramos que fomos ressuscitados para uma vida nova. Terceiro, é um testemunho público — uma declaração diante da igreja e do mundo de que agora pertencemos a Jesus.\n\n**Quem deve ser batizado**\n\nO padrão do Novo Testamento é que o batismo segue a fé pessoal em Cristo. Em Atos 8:36-38, o eunuco etíope creu no evangelho e pediu para ser batizado imediatamente. O batismo não é o que nos salva, mas é o próximo passo natural de quem já foi salvo e deseja declarar publicamente sua fé.\n\n**Batismo não salva, mas obedece**\n\nÉ importante entender: a água não tem poder mágico de limpar pecados. Somos salvos pela graça, mediante a fé (Efésios 2:8-9), não pelo batismo. Mas o batismo é um ato de obediência que Jesus ordenou (Mateus 28:19), e negligenciá-lo é perder uma bênção e um testemunho poderoso que Deus preparou para os que creem.",
    referencias: [
      "Mateus 3:13-17 — O batismo de Jesus",
      "Mateus 28:19 — Ide, fazei discípulos, batizando-os",
      "Atos 2:38-41 — Arrependei-vos e sede batizados",
      "Atos 8:35-38 — O batismo do eunuco etíope",
      "Colossenses 2:12 — Sepultados com ele no batismo",
      "1 Pedro 3:21 — O batismo agora também vos salva, não como remoção da imundícia da carne, mas como compromisso de uma boa consciência",
    ],
    perguntas: [
      "Se você já foi batizado, o que essa experiência representou na sua caminhada com Deus?",
      "Se ainda não foi batizado, o que tem impedido você de dar esse passo de obediência?",
      "Como você explicaria, com suas próprias palavras, o que o batismo simboliza?",
      "Por que é importante que o batismo seja um testemunho público, e não apenas uma decisão privada?",
    ],
    oracao: "Senhor Jesus, assim como Tu foste batizado para nos dar exemplo, eu também quero obedecer ao Teu chamado. Que o batismo seja um marco na minha vida — a declaração pública de que morri para o meu antigo eu e vivo agora para Ti, em novidade de vida. Amém."
  },
  {
    id: "f3", nivel: "iniciante", fixo: true,
    titulo: "Por que ir à Igreja?",
    versiculo: "Hebreus 10:25 — \"Não deixando de congregar-nos, como é costume de alguns; antes, façamo-lo, e tanto mais quanto vedes que se aproxima aquele Dia.\"",
    texto: "Em uma época em que muitos dizem 'eu creio em Deus, mas não preciso de igreja', vale a pena entender por que Deus criou a igreja e por que ela é essencial na vida do crente.\n\n**A igreja é família, não prédio**\n\nQuando a Bíblia fala de 'igreja' (do grego 'ekklesia', que significa 'os chamados para fora'), ela nunca se refere a um edifício, mas a pessoas — o povo de Deus reunido. Você não 'vai à igreja'; você É a igreja, e se reúne com outros membros do corpo de Cristo.\n\n**Precisamos uns dos outros**\n\nDeus nos criou para viver em comunidade, não isoladamente. 'Como o corpo é um, mas tem muitos membros... assim é Cristo também' (1 Coríntios 12:12). Nenhum cristão foi projetado para caminhar sozinho. Precisamos de outros para nos incentivar, corrigir, apoiar e caminhar ao nosso lado.\n\n**Adoração coletiva**\n\nHá algo poderoso e único em adorar a Deus junto com outros crentes que não se experimenta sozinho. Os Salmos frequentemente convocam a adoração coletiva: 'Vinde, adoremos e prostremo-nos; ajoelhemos diante do Senhor que nos criou' (Salmos 95:6). A igreja reunida antecipa a cena do céu, onde uma multidão de todas as nações adorará juntos ao Cordeiro (Apocalipse 7:9-10).\n\n**Crescimento através da comunidade**\n\nEfésios 4:11-16 ensina que Deus deu líderes à igreja 'para o aperfeiçoamento dos santos... até chegarmos todos à unidade da fé'. O crescimento espiritual acontece de forma mais saudável em comunidade — através do ensino, do serviço, da correção fraterna e do exemplo de outros.\n\n**Um lugar imperfeito, mas necessário**\n\nA igreja é formada por pessoas imperfeitas, e por isso decepções acontecem. Mas abandonar a igreja por causa de suas imperfeições é como abandonar sua própria família por causa de conflitos. Deus não chamou apenas indivíduos — Ele chamou um povo. Fazer parte de uma igreja local não é opcional para quem quer crescer como Jesus deseja.",
    referencias: [
      "Atos 2:42-47 — A vida da igreja primitiva",
      "1 Coríntios 12:12-27 — Somos um corpo, com muitos membros",
      "Efésios 4:11-16 — Crescendo juntos até a estatura de Cristo",
      "Hebreus 10:24-25 — Não deixando de congregar-nos",
      "Salmos 133:1 — Que bom e que suave é habitarem os irmãos em união",
      "Apocalipse 7:9-10 — A multidão adorando junto diante do trono",
    ],
    perguntas: [
      "O que a comunidade da igreja tem representado na sua vida espiritual até agora?",
      "Você já pensou em se afastar da igreja em algum momento? O que motivou isso?",
      "Como você pode ser mais do que um 'espectador' e se tornar um participante ativo da igreja local?",
      "De que forma você pode ajudar alguém a se sentir acolhido e parte da família da igreja?",
    ],
    oracao: "Pai, obrigado por não me deixar sozinho na caminhada — obrigado pela igreja. Perdoa as vezes em que fui apenas espectador. Ajuda-me a amar a Tua igreja como Tu a amas, a servir com alegria e a permanecer fiel à comunhão dos irmãos, mesmo quando for difícil. Amém."
  },
  {
    id: "f4", nivel: "iniciante", fixo: true,
    titulo: "Como Ler a Bíblia",
    versiculo: "2 Timóteo 3:16-17 — \"Toda a Escritura é divinamente inspirada e proveitosa para ensinar, para redarguir, para corrigir, para instruir em justiça.\"",
    texto: "Muitos cristãos têm uma Bíblia em casa, mas poucos sabem como lê-la de forma que realmente transforme sua vida. Aqui estão princípios simples para começar bem.\n\n**A Bíblia não é um livro comum**\n\nAo contrário de qualquer outro livro, a Bíblia é a Palavra viva de Deus. 'Porque a palavra de Deus é viva e eficaz' (Hebreus 4:12). Isso significa que, ao ler as Escrituras, não estamos apenas absorvendo informação — estamos nos encontrando com o próprio Deus, que fala através delas.\n\n**Antes de ler, ore**\n\nO Salmo 119:18 traz um pedido simples e poderoso: 'Abre os meus olhos, para que veja as maravilhas da tua lei.' Antes de abrir a Bíblia, peça ao Espírito Santo para iluminar sua mente. Sem essa dependência, a leitura pode se tornar apenas um exercício intelectual, e não um encontro espiritual.\n\n**Leia com contexto**\n\nUm erro comum é tirar versículos isolados do seu contexto. Pergunte sempre: quem escreveu este texto, para quem, e por quê? Que tipo de literatura é (história, poesia, carta, profecia)? O que vem antes e depois desse trecho? O contexto evita interpretações equivocadas.\n\n**Pergunte: o que isso revela, o que isso significa, o que devo fazer?**\n\nUm método simples e eficaz é fazer três perguntas a cada leitura: O que este texto revela sobre o caráter de Deus? O que ele revela sobre a condição humana ou sobre mim? Como devo responder — em atitude, oração ou ação — ao que acabei de ler? Esse processo transforma leitura em aplicação.\n\n**Um hábito, não um evento**\n\nAssim como o corpo precisa de alimento diário, a alma precisa da Palavra diariamente. 'Bem-aventurado o homem que... no seu prazer está na lei do Senhor, e na sua lei medita de dia e de noite' (Salmos 1:1-2). Não é necessário ler muito de uma vez — o importante é a constância. Comece com poucos minutos por dia e deixe esse hábito crescer.",
    referencias: [
      "Salmos 1:1-3 — Bem-aventurado o que medita na lei do Senhor",
      "Salmos 119:105 — Lâmpada para os meus pés é a tua palavra",
      "Josué 1:8 — Não se aparte da tua boca o livro desta lei",
      "2 Timóteo 3:16-17 — Toda Escritura é proveitosa para ensinar",
      "Hebreus 4:12 — A palavra de Deus é viva e eficaz",
      "Tiago 1:22 — Sede cumpridores da palavra e não somente ouvintes",
    ],
    perguntas: [
      "Como tem sido sua relação com a leitura da Bíblia até hoje — constante, esporádica ou quase inexistente?",
      "Qual dos princípios apresentados (oração antes de ler, atenção ao contexto, as três perguntas) você mais precisa aplicar?",
      "Que horário do seu dia poderia se tornar um tempo fixo de leitura bíblica?",
      "Compartilhe um versículo que já impactou profundamente sua vida e explique por quê.",
    ],
    oracao: "Senhor, obrigado por Tua Palavra, que é lâmpada para os meus pés. Abre os meus olhos para enxergar as maravilhas dela. Que a leitura da Bíblia deixe de ser uma obrigação e se torne um encontro diário contigo. Transforma-me pela renovação da minha mente através da Tua Palavra. Amém."
  },
  {
    ...
    texto: "Entender o pecado e o perdão de forma bíblica é essencial para viver com liberdade, sem culpa nem indiferença.\n\n**O que é pecado**\n\nA palavra grega para pecado, 'hamartia', significa literalmente 'errar o alvo'. Pecado não é apenas fazer coisas 'erradas' — é viver fora do propósito e do padrão de Deus para nossa vida. 'Todos nós andávamos desgarrados como ovelhas; cada um se desviava pelo seu caminho' (Isaías 53:6). Ninguém está isento — 'não há um justo, nem um sequer' (Romanos 3:10).\n\n**A boa notícia do perdão**\n\nO evangelho não termina no diagnóstico do pecado — ele revela a cura. 'Nele temos a redenção, pelo seu sangue, a saber, a remissão dos pecados' (Efésios 1:7). O perdão de Deus não é uma tolerância superficial — foi comprado ao preço da morte de Jesus na cruz. É um perdão completo, custoso e definitivo.\n\n**Confissão: honestidade com Deus**\n\nO versículo-chave deste estudo nos ensina que confessar os pecados é o caminho para experimentar o perdão já disponível. Confessar não é informar a Deus algo que Ele não sabe — é concordar com Ele sobre o que está errado, abandonando a autojustificação e a negação. É um ato de humildade que abre a porta para a restauração.\n\n**Perdoados, não perfeitos**\n\nMuitos cristãos vivem com culpa constante, achando que precisam 'se sentir suficientemente arrependidos' para merecer o perdão. Mas o perdão não se baseia em nossos sentimentos — baseia-se na obra completa de Cristo. 'Não há, pois, agora, condenação alguma para os que estão em Cristo Jesus' (Romanos 8:1). Somos chamados a crescer em santidade, mas não a viver sob condenação.\n\n**Perdoar aos outros**\n\nJesus conectou o perdão que recebemos com o perdão que oferecemos: 'Perdoai, e sereis perdoados' (Lucas 6:37). Guardar mágoa e ressentimento contradiz o evangelho que recebemos gratuitamente. Assim como fomos perdoados de uma dívida impagável, somos chamados a perdoar os que pecam contra nós.",
    referencias: [
      "Isaías 53:6 — Todos nós andávamos desgarrados como ovelhas",
      "Romanos 3:23 — Todos pecaram e destituídos estão da glória de Deus",
      "1 João 1:9 — Se confessarmos os nossos pecados, ele é fiel para perdoar",
      "Romanos 8:1 — Nenhuma condenação para os que estão em Cristo",
      "Salmos 103:12 — Quanto está o oriente afastado do ocidente, assim afasta de nós as nossas transgressões",
      "Mateus 18:21-22 — Perdoar setenta vezes sete",
    ],
    perguntas: [
      "Você costuma viver com culpa mesmo depois de confessar um pecado a Deus? Por que isso acontece?",
      "O que significa, na prática, 'concordar com Deus' sobre um pecado, em vez de justificá-lo?",
      "Existe alguém que você precisa perdoar hoje? O que tem impedido você de fazer isso?",
      "Como a certeza de que não há condenação para quem está em Cristo muda a forma como você lida com suas falhas?",
    ],
    oracao: "Pai, eu Te confesso meus pecados e reconheço que preciso do Teu perdão todos os dias. Obrigado porque, em Cristo, sou perdoado e não há condenação sobre mim. Ajuda-me também a perdoar aqueles que pecaram contra mim, assim como fui perdoado por Ti. Amém."
  },
  {
    id: "f6", nivel: "iniciante", fixo: true,
    titulo: "Vivendo como Discípulo de Jesus",
    versiculo: "Lucas 9:23 — \"E dizia a todos: Se alguém quer vir após mim, negue-se a si mesmo, tome cada dia a sua cruz e siga-me.\"",
    texto: "Ser cristão vai muito além de crer em Jesus — é ser Seu discípulo, alguém que aprende dEle e vive como Ele viveu.\n\n**O que é um discípulo**\n\nNo tempo de Jesus, um discípulo ('mathetes') era alguém que seguia um mestre não apenas para aprender conceitos, mas para imitar sua forma de viver. Ser discípulo de Jesus significa muito mais do que frequentar a igreja ou saber teologia — é permitir que Sua vida molde a nossa, dia após dia.\n\n**Negar-se a si mesmo**\n\nJesus foi claro: seguir a Ele exige negar a si mesmo. Isso não significa se odiar, mas destronar o 'eu' do centro da vida e colocar Jesus nesse lugar. Nossas vontades, planos e desejos passam a ser submetidos à Sua vontade. É uma morte diária ao egoísmo.\n\n**Seguir diariamente**\n\nRepare que Jesus disse 'tome cada dia a sua cruz' — não é uma decisão única, mas uma escolha renovada todos os dias. O discipulado não é um evento no passado (como o momento da conversão), mas um caminho contínuo de submissão e crescimento.\n\n**Discipulado é relacional**\n\nJesus não discipulou multidões à distância — Ele viveu de perto com os doze, comeu com eles, viajou com eles, corrigiu e ensinou pessoalmente. Discipulado bíblico floresce em relacionamento, não apenas em salas de aula. Buscar alguém mais maduro na fé para caminhar ao seu lado — e, com o tempo, fazer o mesmo por outros — é parte essencial do chamado cristão.\n\n**O fruto de uma vida discipulada**\n\nJesus disse: 'Nisto conhecerão todos que sois meus discípulos, se vos amardes uns aos outros' (João 13:35). O sinal de um discípulo maduro não é apenas conhecimento bíblico, mas um caráter transformado — amor, humildade, serviço, integridade. Gálatas 5:22-23 chama isso de 'fruto do Espírito': o resultado natural de uma vida que segue Jesus de perto.",
    referencias: [
      "Lucas 9:23-24 — Negar-se a si mesmo e seguir a Jesus",
      ...
      "Mateus 28:19-20 — Ide, fazei discípulos de todas as nações",
      "2 Timóteo 2:2 — Confia isso a homens fiéis, que ensinem também a outros",
    ],
    perguntas: [
      "O que significa 'negar-se a si mesmo' na sua realidade específica hoje?",
      "Você tem alguém mais maduro na fé caminhando ao seu lado como discipulador? E alguém que você está discipulando?",
      "Qual área da sua vida ainda resiste em se submeter ao senhorio de Jesus?",
      "Como as pessoas ao seu redor percebem — ou não percebem — que você é discípulo de Jesus?",
    ],
    oracao: "Senhor Jesus, quero ser Teu discípulo de verdade — não apenas alguém que sabe sobre Ti, mas alguém que anda contigo todos os dias. Ensina-me a negar meu egoísmo, a tomar minha cruz diariamente e a Te seguir de perto. Que minha vida produza o fruto do Teu Espírito. Amém."
  },

  // ══ AVANÇADOS ══
  {
    id: "f7", nivel: "avancado", fixo: true,
    titulo: "Os Dons do Espírito Santo",
    versiculo: "1 Coríntios 12:7 — \"A cada um, porém, é dada a manifestação do Espírito, visando um fim proveitoso.\"",
    texto: "Deus não apenas nos salva — Ele nos capacita, através de dons espirituais, para servir Seu Reino de forma única e poderosa.\n\n**Dons como graça, não mérito**\n\nA palavra grega para dons espirituais, 'charismata', vem da mesma raiz de 'charis' (graça). Os dons não são recompensas por bom comportamento, nem conquistas espirituais — são presentes gratuitos que o Espírito Santo distribui 'como lhe apraz' (1 Coríntios 12:11). Ninguém merece um dom; todo crente recebe ao menos um.\n\n**Diversidade de dons, mesmo Espírito**\n\nPaulo usa a metáfora do corpo humano para explicar os dons: 'há diversidade de dons, mas o Espírito é o mesmo' (1 Coríntios 12:4). Assim como o corpo tem olhos, mãos e pés — todos necessários e diferentes — a igreja precisa da diversidade de dons funcionando juntos. Nenhum dom é superior a outro; todos servem ao mesmo propósito.\n\n**Os dons listados nas Escrituras**\n\nO Novo Testamento lista dons em três principais passagens: Romanos 12:6-8 (profecia, serviço, ensino, exortação, contribuição, liderança, misericórdia), 1 Coríntios 12:8-10 (sabedoria, conhecimento, fé, cura, milagres, profecia, discernimento, línguas, interpretação) e Efésios 4:11 (apóstolos, profetas, evangelistas, pastores, mestres). Essas listas não são exaustivas, mas ilustrativas da generosidade criativa de Deus.\n\n**Como descobrir seu dom**\n\nDescobrir seu dom geralmente envolve três elementos: a paixão que Deus colocou em seu coração, a confirmação de outros crentes que reconhecem esse dom operando em você, e a oportunidade de exercê-lo servindo. Muitas vezes, o dom se revela mais claramente na prática do serviço do que na reflexão teórica.\n\n**Dons a serviço do amor**\n\n1 Coríntios 13 está estrategicamente posicionado entre dois capítulos sobre dons espirituais — um lembrete de que dons exercidos sem amor 'nada valem' (1 Coríntios 13:2). O propósito final dos dons não é exibição pessoal, mas edificação do corpo de Cristo em amor (Efésios 4:16).",
    referencias: [
      "Romanos 12:4-8 — Temos diferentes dons, segundo a graça",
      "1 Coríntios 12:4-11 — Diversidade de dons, mesmo Espírito",
      "1 Coríntios 12:12-27 — O corpo e seus muitos membros",
      "1 Coríntios 13:1-3 — Sem amor, nada sou",
      "Efésios 4:11-13 — Os dons para o aperfeiçoamento dos santos",
      "1 Pedro 4:10-11 — Cada um administre o dom recebido para servir aos outros",
    ],
    perguntas: [
      "Você já identificou algum dom espiritual operando em você? Como percebeu isso?",
      "De que forma você tem usado (ou pode começar a usar) seu dom para servir a igreja?",
      "Por que é perigoso comparar dons ou considerar alguns 'mais importantes' que outros?",
      "Como o amor deve moldar a maneira como exercemos nossos dons espirituais?",
    ],
    oracao: "Espírito Santo, obrigado por me capacitar com dons para servir ao corpo de Cristo. Ajuda-me a descobrir e desenvolver os dons que colocaste em mim, e a exercê-los sempre em amor, para a edificação da igreja e para a Tua glória. Amém."
  },
  {
    id: "f8", nivel: "avancado", fixo: true,
    titulo: "Escatologia: A Segunda Vinda de Cristo",
    versiculo: "Atos 1:11 — \"...este mesmo Jesus, que dentre vós foi assunto acima para o céu, há de vir do modo como para o céu o vistes ir.\"",
    texto: "A esperança da volta de Jesus é uma das doutrinas mais mencionadas no Novo Testamento — e também uma das mais mal compreendidas.\n\n**A promessa da volta de Cristo**\n\nAntes de subir ao céu, Jesus prometeu: 'Voltarei e vos tomarei para mim mesmo, para que, onde eu estiver, estejais vós também' (João 14:3). Os anjos confirmaram aos discípulos que Ele voltaria da mesma forma visível como partiu (Atos 1:11). Essa não é uma promessa marginal — é mencionada centenas de vezes no Novo Testamento.\n\n**Como será**\n\nA Bíblia descreve a volta de Cristo como visível e gloriosa: 'Eis que vem com as nuvens, e todo olho o verá' (Apocalipse 1:7). 1 Tessalonicenses 4:16-17 descreve a ressurreição dos mortos em Cristo e a reunião dos vivos com Ele nos ares. Diferente da primeira vinda, humilde e discreta, a segunda vinda será pública e inegável.\n\n**Vivendo à luz da esperança**\n\nCuriosamente, a Bíblia raramente menciona a volta de Cristo apenas como informação — quase sempre como motivação para uma vida santa e vigilante. 'Todo o que tem esta esperança nele purifica-se a si mesmo, assim como ele é puro' (1 João 3:3). A escatologia bíblica não é para satisfazer curiosidade, mas para transformar comportamento presente.\n\n**O que não sabemos**\n\nJesus foi claro: 'daquele dia e hora ninguém sabe... senão só meu Pai' (Mateus 24:36). A Bíblia não nos dá um calendário detalhado, e tentativas históricas de calcular datas sempre falharam. Nosso chamado não é decifrar cronogramas, mas estar preparados a qualquer momento — como servos vigilantes esperando o Senhor da casa (Lucas 12:35-40).\n\n**Uma esperança que purifica**\n\nA doutrina da segunda vinda nos lembra que a história tem um destino, que a injustiça não terá a última palavra, e que Deus completará o que começou. Isso nos dá esperança em meio ao sofrimento presente e nos motiva a viver com integridade, sabendo que prestaremos contas diante dEle.",
    referencias: [
      "João 14:1-3 — Voltarei e vos tomarei para mim",
      "Atos 1:9-11 — Este mesmo Jesus voltará como o vistes subir",
      "1 Tessalonicenses 4:16-18 — A ressurreição e o encontro com o Senhor",
      "Mateus 24:36-44 — Ninguém sabe o dia nem a hora; vigiai",
      "Apocalipse 1:7 — Eis que vem com as nuvens, e todo olho o verá",
      "1 João 3:2-3 — Esta esperança nos purifica",
    ],
    perguntas: [
      "Como a certeza da volta de Jesus impacta a forma como você vive o presente?",
      "Por que você acha que a Bíblia enfatiza vigilância em vez de especulação sobre datas?",
      "De que forma essa esperança pode confortar alguém que está sofrendo injustiça ou perda?",
      "O que significa, na prática, 'purificar-se' à luz da esperança da volta de Cristo?",
    ],
    oracao: "Senhor Jesus, creio na Tua promessa de que voltarás. Que essa esperança não seja apenas uma doutrina que conheço, mas uma realidade que me purifica e me motiva a viver com integridade. Ajuda-me a viver vigilante, esperando-Te a cada dia. Amém."
  },
  {
    id: "f9", nivel: "avancado", fixo: true,
    titulo: "Santificação: O Processo de Crescer em Cristo",
    versiculo: "Filipenses 1:6 — \"...tendo por certo isto mesmo, que aquele que em vós começou a boa obra a aperfeiçoará até ao dia de Jesus Cristo.\"",
    texto: "Se a justificação é o momento em que somos declarados justos diante de Deus, a santificação é o processo pelo qual nos tornamos, na prática, mais parecidos com Cristo.\n\n**Justificação x Santificação**\n\nÉ essencial distinguir esses dois conceitos. Justificação é instantânea — no momento em que cremos, somos declarados justos diante de Deus, com base na obra de Cristo (Romanos 5:1). Santificação é progressiva — é o processo contínuo pelo qual o Espírito Santo transforma nosso caráter, atitudes e comportamento ao longo da vida. Somos justificados de uma vez; somos santificados dia após dia.\n\n**Um processo, não um evento**\n\n2 Coríntios 3:18 descreve isso lindamente: 'todos nós, com rosto descoberto, refletindo, como um espelho, a glória do Senhor, somos transformados de glória em glória'. Repare: 'transformados', tempo contínuo. Ninguém se torna maduro instantaneamente — a santificação é uma jornada de toda a vida, com avanços e retrocessos.\n\n**A cooperação entre graça e disciplina**\n\nFilipenses 2:12-13 apresenta um equilíbrio importante: 'efetuai a vossa salvação com temor e tremor, porque Deus é o que opera em vós tanto o querer como o efetuar'. A santificação não é só passiva ('deixa Deus fazer tudo') nem só ativa ('esforço próprio sem graça') — é cooperação. Deus opera em nós, e somos chamados a responder com disciplina espiritual.\n\n**Meios de graça**\n\nDeus normalmente santifica Seu povo através de meios ordinários: a Palavra ('santifica-os na verdade; a tua palavra é a verdade', João 17:17), a oração, a comunhão da igreja, os sacramentos/ordenanças, e as provações (Tiago 1:2-4). Não há atalhos místicos — o crescimento acontece através da fidelidade nas disciplinas comuns da fé.\n\n**Progresso, não perfeição**\n\nMesmo o apóstolo Paulo, depois de décadas seguindo a Cristo, disse: 'não que já a tenha alcançado, ou que seja perfeito; mas prossigo' (Filipenses 3:12). Santificação bíblica não exige perfeição instantânea, mas progresso genuíno e perseverança. A meta final é clara — sermos conformes à imagem de Cristo (Romanos 8:29) — mas a jornada até lá é gradual.",
    referencias: [
      ...
      "Filipenses 2:12-13 — Deus opera em vós o querer e o efetuar",
      "João 17:17 — Santifica-os na verdade; a tua palavra é a verdade",
      "Filipenses 3:12-14 — Prossigo para o alvo, para o prêmio da soberana vocação",
    ],
    perguntas: [
      "Você já confundiu justificação com santificação — achando que precisa 'se aperfeiçoar' para ser aceito por Deus?",
      "Quais 'meios de graça' (Palavra, oração, comunhão, provações) têm sido mais presentes na sua vida atualmente?",
      "Em que áreas você percebe crescimento genuíno nos últimos anos? E em quais ainda luta?",
      "Como encontrar equilíbrio entre depender da graça de Deus e se esforçar ativamente para crescer?",
    ],
    oracao: "Senhor, obrigado porque já me declaraste justo em Cristo, e obrigado por continuares operando em mim, transformando-me à Tua imagem. Que eu coopere com a Tua graça através da Palavra, da oração e da comunhão, sabendo que aquele que começou a boa obra em mim a aperfeiçoará. Amém."
  },
  {
    id: "f10", nivel: "avancado", fixo: true,
    titulo: "A Soberania de Deus e o Livre-Arbítrio",
    versiculo: "Provérbios 16:9 — \"O coração do homem propõe o seu caminho, mas o Senhor lhe dirige os passos.\"",
    texto: "Poucos temas geram tanto debate teológico quanto a relação entre a soberania absoluta de Deus e a real responsabilidade humana. A Bíblia afirma ambas as verdades — sem resolver completamente a tensão entre elas.\n\n**A soberania de Deus**\n\nA Escritura é enfática: Deus reina sobre tudo. 'O nosso Deus está nos céus; faz tudo o que lhe apraz' (Salmos 115:3). Nada acontece fora do controle e do conhecimento de Deus — desde a queda de um pardal (Mateus 10:29) até os planos de nações inteiras (Provérbios 21:1). Ele não é um espectador passivo do universo, mas seu Rei ativo e soberano.\n\n**A responsabilidade humana**\n\nAo mesmo tempo, a Bíblia trata os seres humanos como agentes morais reais, responsáveis por suas escolhas. Deus chama as pessoas ao arrependimento (Atos 17:30), adverte sobre consequências de decisões (Gálatas 6:7) e julgará cada um 'segundo as suas obras' (Apocalipse 20:12). Se fôssemos meras marionetes sem escolha real, essas exortações não fariam sentido.\n\n**Um mistério, não uma contradição**\n\nA Bíblia nunca tenta resolver filosoficamente essa tensão — ela simplesmente afirma as duas verdades lado a lado, muitas vezes no mesmo texto. Deus não nos convida a escolher um lado, mas a abraçar o mistério com humildade, reconhecendo que Sua mente é 'infinitamente' maior que a nossa (Isaías 55:8-9).\n\n**Exemplos bíblicos**\n\nA história de José ilustra isso poderosamente: seus irmãos o venderam como escravo por maldade genuína — uma escolha real e responsável. Mas José depois declara: 'vós intentastes o mal contra mim; porém Deus o intentou para o bem' (Gênesis 50:20). A mesma história tem, simultaneamente, escolha humana responsável e soberania divina perfeita. A crucificação de Jesus segue o mesmo padrão (Atos 2:23) — o maior crime da história humana, e ao mesmo tempo o plano predeterminado de Deus para a salvação.\n\n**Descanso na soberania de Deus**\n\nEm vez de gerar ansiedade, essa doutrina foi dada para trazer descanso. Se Deus reina soberanamente sobre tudo — inclusive sobre nossos erros, sofrimentos e incertezas — podemos confiar que Ele está trabalhando 'todas as coisas... para o bem daqueles que amam a Deus' (Romanos 8:28), mesmo quando não entendemos o caminho.",
    referencias: [
      "Salmos 115:3 — Faz tudo o que lhe apraz",
      "Provérbios 16:9 — O Senhor dirige os passos do homem",
      "Gênesis 50:20 — Vós intentastes o mal, mas Deus o intentou para o bem",
      "Atos 2:23 — Entregue pelo determinado conselho e presciência de Deus",
      "Romanos 8:28-30 — Todas as coisas cooperam para o bem",
      "Isaías 55:8-9 — Os meus pensamentos não são os vossos pensamentos",
    ],
    perguntas: [
      "Como você reagia, antes deste estudo, quando pensava na relação entre soberania de Deus e livre-arbítrio?",
      "De que forma a história de José ilustra as duas verdades funcionando juntas?",
      "Como a soberania de Deus pode trazer descanso em uma circunstância difícil que você vive hoje?",
      "Por que é saudável aceitar mistérios teológicos sem exigir uma explicação completa e lógica?",
    ],
    oracao: "Senhor, Tu és soberano sobre todas as coisas, e ainda assim me chamas a responder com fé e obediência. Ajuda-me a descansar na Tua soberania quando não entendo o caminho, e a viver com responsabilidade diante das escolhas que me confiaste. Teus caminhos são mais altos que os meus. Amém."
  },
  {
    id: "f11", nivel: "avancado", fixo: true,
    titulo: "Aliança: Do Antigo ao Novo Testamento",
    versiculo: "Jeremias 31:33 — \"...porei a minha lei no seu interior, e a escreverei no seu coração; e eu serei o seu Deus, e eles serão o meu povo.\"",
    texto: "A ideia de aliança é um dos fios condutores que unifica toda a Bíblia, do Gênesis ao Apocalipse. Entender as alianças ajuda a compreender a própria história da redenção.\n\n**O que é uma aliança**\n\nNo mundo antigo, uma aliança ('berith' em hebraico) era um acordo solene entre partes, frequentemente selado com sangue, promessas e obrigações mútuas. Quando Deus faz alianças com Seu povo, Ele estabelece unilateralmente os termos de um relacionamento — revelando quem Ele é e o que espera de Seu povo.\n\n**As alianças do Antigo Testamento**\n\nA Bíblia registra diversas alianças progressivas: com Noé (promessa de nunca mais destruir a terra com dilúvio, Gênesis 9), com Abraão (promessa de descendência, terra e bênção para todas as nações, Gênesis 12 e 15), com Israel no Sinai (a lei mosaica, condicionada à obediência, Êxodo 19-24), e com Davi (promessa de um reino e trono eternos, 2 Samuel 7). Cada aliança revela mais do caráter e do plano de Deus.\n\n**A Nova Aliança em Cristo**\n\nJeremias profetizou uma aliança diferente das anteriores — não escrita em tábuas de pedra, mas no próprio coração do povo (Jeremias 31:31-34). Jesus declarou, na última ceia, que Seu sangue selava exatamente essa Nova Aliança: 'Este cálice é o Novo Testamento no meu sangue' (Lucas 22:20). Hebreus 8-10 explica detalhadamente como Cristo é o mediador de uma aliança superior, baseada em melhores promessas.\n\n**A continuidade e a novidade**\n\nA Nova Aliança não anula as promessas anteriores — ela as cumpre. A promessa a Abraão de bênção para todas as nações se realiza no evangelho alcançando o mundo (Gálatas 3:8-9,29). O trono eterno prometido a Davi se cumpre no reinado eterno de Jesus (Lucas 1:32-33). A lei que exigia obediência externa agora é escrita internamente pelo Espírito Santo (Ezequiel 36:26-27).\n\n**Vivendo sob a Nova Aliança**\n\nDiferente da aliança mosaica, baseada em nossa obediência à lei, a Nova Aliança é baseada na obra completa de Cristo e sustentada pela obra interna do Espírito Santo. Isso não elimina a obediência — mas muda sua fonte: já não obedecemos para conquistar aceitação, mas a partir da aceitação já garantida em Cristo, com o Espírito nos capacitando por dentro.",
    referencias: [
      "Gênesis 12:1-3 — A aliança abraâmica: bênção para todas as nações",
      "2 Samuel 7:12-16 — A aliança davídica: um trono eterno",
      "Jeremias 31:31-34 — A promessa da Nova Aliança",
      "Lucas 22:19-20 — Este cálice é a Nova Aliança no meu sangue",
      "Hebreus 8:6-13 — Um mediador de uma aliança superior",
      "Gálatas 3:26-29 — Herdeiros segundo a promessa em Cristo",
    ],
    perguntas: [
      "Como entender as alianças do Antigo Testamento ajuda a entender melhor o plano de Deus como um todo?",
      "Qual a diferença fundamental entre obedecer para ganhar aceitação e obedecer a partir da aceitação já recebida?",
      "De que forma a promessa a Abraão — bênção para todas as nações — se cumpre na sua própria vida?",
      "O que significa, na prática, ter a lei de Deus 'escrita no coração' pelo Espírito, e não apenas em regras externas?",
    ],
    oracao: "Pai, obrigado por seres um Deus de aliança — fiel às Tuas promessas através de toda a história. Obrigado por incluir-me na Nova Aliança selada pelo sangue de Jesus. Escreve Tua lei no meu coração pelo Teu Espírito, e que eu viva não por obrigação, mas por gratidão e amor. Amém."
  },
  {
    id: "f12", nivel: "avancado", fixo: true,
    titulo: "Discipulado e Multiplicação",
    versiculo: "2 Timóteo 2:2 — \"E o que de mim, entre muitas testemunhas, ouviste, confia-o a homens fiéis, que sejam idôneos para também ensinarem os outros.\"",
    texto: "A Grande Comissão não termina em fazer convertidos — ela chama a igreja a fazer discípulos que façam outros discípulos, geração após geração.\n\n**A Grande Comissão é sobre multiplicação**\n\nMateus 28:19-20 registra a última ordem de Jesus: 'Ide, fazei discípulos de todas as nações... ensinando-os a guardar todas as coisas que vos tenho ordenado'. Repare que o alvo não é apenas anunciar o evangelho, mas formar discípulos maduros, capazes de obedecer e, por sua vez, formar outros discípulos.\n\n**Discipulado geracional**\n\n2 Timóteo 2:2 apresenta uma cadeia poderosa de multiplicação: Paulo ensinou Timóteo, que deveria ensinar 'homens fiéis', que por sua vez seriam 'idôneos para também ensinarem os outros'. São quatro gerações espirituais visíveis num único versículo. Esse é o modelo bíblico de crescimento — não apenas adição, mas multiplicação exponencial através das gerações.\n\n**Investir em poucos**\n\nJesus, embora ministrasse a multidões, investiu Seu tempo mais intensamente em doze homens — e de forma ainda mais próxima em três (Pedro, Tiago e João). O modelo de Jesus prioriza profundidade de relacionamento sobre amplitude superficial. Discipular poucos de forma profunda produz mais frutos duradouros do que ensinar multidões superficialmente.\n\n**O custo e a alegria de discipular**\n\nDiscipular exige tempo, vulnerabilidade e paciência — Jesus caminhou com Seus discípulos por três anos, suportando suas falhas, dúvidas e até traições. Paulo descreveu seu cuidado com os tessalonicenses como o de 'uma ama que cria seus próprios filhos' (1 Tessalonicenses 2:7-8). É um investimento custoso, mas Paulo também descreveu seus discípulos como 'nossa glória e gozo' (1 Tessalonicenses 2:20) — a alegria de ver outros crescerem em Cristo.\n\n**Um chamado para todos**\n\nDiscipular não é tarefa exclusiva de pastores ou líderes formais — é o chamado de todo cristão maduro. Você não precisa ter todas as respostas; precisa apenas estar um passo à frente e disposto a caminhar ao lado de alguém, compartilhando 'não somente o evangelho de Deus, mas também a nossa própria alma' (1 Tessalonicenses 2:8). A igreja cresce saudável quando cada membro discipula e é discipulado.",
    referencias: [
      "Mateus 28:18-20 — Ide, fazei discípulos de todas as nações",
      "Marcos 3:14 — Designou doze para que estivessem com ele",
      "2 Timóteo 2:2 — Confia a homens fiéis, idôneos para ensinar outros",
      "1 Tessalonicenses 2:7-8 — Como uma ama que cria seus próprios filhos",
      "1 Tessalonicenses 2:19-20 — Vós sois a nossa glória e gozo",
      "Provérbios 27:17 — Como o ferro afia o ferro, assim o homem afia o seu amigo",
    ],
    perguntas: [
      "Alguém investiu profundamente em você espiritualmente? Como essa experiência moldou sua caminhada?",
      "Você está, hoje, discipulando alguém de forma intencional? Se não, o que impede isso?",
      "Por que o modelo de Jesus — investir profundamente em poucos — é tão diferente da nossa cultura de alcance em massa?",
      "O que significa, na prática, compartilhar 'a própria alma' com quem você discipula, e não apenas informações?",
    ],
    oracao: "Senhor, obrigado por aqueles que investiram em mim e me ajudaram a crescer na fé. Dá-me coragem e disponibilidade para investir em outros, discipulando com paciência e amor, para que a Tua igreja se multiplique de geração em geração até que o evangelho alcance todas as nações. Amém."
  },
];
...
export default function FamiliaAliancaApp() {
  ...
  const [membrosView, setMembrosView] = useState("lista"); // lista | aniversariantes | duplicados | inativos
  ...
  const S = {
    app: { minHeight: "100dvh", background: T.bg, color: T.text, fontFamily: "'Georgia', 'Times New Roman', serif", position: "relative", overflowX: "hidden" },
    ...
    splash: { minHeight: "100dvh", background: T.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 24 },
    ...
    loginWrap: { minHeight: "100dvh", background: T.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "32px 28px" },
    ...
    toast: { position: "fixed", bottom: "calc(100px + env(safe-area-inset-bottom, 0px))", left: "50%", transform: "translateX(-50%)", background: darkMode ? "#040e20" : "#fff", border: `1px solid ${darkMode ? "rgba(201,168,76,.3)" : "rgba(154,112,32,.6)"}`, borderRadius: 12, padding: "12px 24px", fontSize: 13, color: T.text, zIndex: 999, whiteSpace: "nowrap", boxShadow: "0 4px 24px rgba(0,0,0,.2)" },
    ...
    <div style={S.app} className="tela-cheia">
      ...
      <style>{`
        * { box-sizing: border-box; }
        html { font-size: 18px; }
        html, body { height: 100%; margin: 0; overscroll-behavior-y: none; overflow-x: hidden; }
        ...
        {tab === "home" && (
          <div style={{ animation: "slideUp .4s ease" }}>
            ...
            {(() => {
              ...
              return (
                <div style={{ margin: "16px 16px 4px", borderRadius: 20, overflow: "hidden", border: `1px solid ${darkMode ? "rgba(201,168,76,.3)" : "rgba(154,112,32,.5)"}`, background: darkMode ? "linear-gradient(135deg,#0a1a3a 0%,#050d1f 60%)" : "linear-gradient(135deg,#f5f0e8 0%,#ede4d0 60%)" }}>
                  <div style={{ background: "linear-gradient(90deg,#c9a84c,#e8c97a)", padding: "6px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
                  ...
                  <div style={{ padding: "14px 16px 16px" }}>
                    <div style={{ fontSize: 10, color: darkMode ? "#e8c97a" : "#8a6416", marginBottom: 4, letterSpacing: 1, textTransform: "uppercase" }}>Semana {semana.semana} • {DIAS_SEMANA_LEITURA.find(d => d.id === diaSemanaHojeLeitura())?.label}</div>
                    <div style={{ fontSize: 17, fontWeight: "bold", lineHeight: 1.25, color: darkMode ? "#fff" : "#080810", marginBottom: 8 }}>{diaHoje.titulo}</div>
                    <div style={{ fontSize: 12, color: T.textSub, lineHeight: 1.5, marginBottom: 12, overflow: "hidden", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical" }}>
          ...
          return (
            <div style={{ animation: "slideUp .4s ease", paddingBottom: 20 }}>
              ...
              {!semana ? (
                ...
                <>
                  <div style={{ margin: "16px 16px 0", background: "linear-gradient(135deg,rgba(201,168,76,.15),rgba(201,168,76,.1))", border: `1px solid ${darkMode ? "rgba(201,168,76,.25)" : "rgba(154,112,32,.5)"}`, borderRadius: 20, padding: "22px", textAlign: "center" }}>
                    <div style={{ fontSize: 11, letterSpacing: 2, textTransform: "uppercase", color: "#c9a84c", marginBottom: 6 }}>Semana {semana.semana}</div>
                  ...
                  <div style={{ display: "flex", gap: 6, overflowX: "auto", padding: "16px 16px 4px" }}>
                    {DIAS_SEMANA_LEITURA.map(d => (
                      <button key={d.id} onClick={() => setDiaVisualizadoLeitura(d.id)}
                        style={{ flexShrink: 0, padding: "8px 12px", borderRadius: 10, border: `1px solid ${diaAtivo === d.id ? "#c9a84c" : T.cardBorder}`, background: diaAtivo === d.id ? "linear-gradient(90deg,#c9a84c,#e8c97a)" : T.card, color: diaAtivo === d.id ? "#080810" : T.textSub, fontSize: 11, fontWeight: diaAtivo === d.id ? "bold" : "normal", cursor: "pointer", fontFamily: "Georgia,serif", whiteSpace: "nowrap" }}>
                  ...
                  {!conteudoDia ? (
                    ...
                    <div style={{ margin: "12px 16px 0", background: T.card, border: "1px solid " + T.cardBorder, borderRadius: 16, padding: "20px" }}>
                      ...
                      <div style={{ fontSize: 11, letterSpacing: 2, textTransform: "uppercase", color: "#c9a84c", marginBottom: 8 }}>📖 Versículo Base</div>
                      <div style={{ fontSize: 15, fontStyle: "italic", color: T.text, lineHeight: 1.7, marginBottom: 6 }}>"{conteudoDia.versiculoTexto}"</div>
                      {conteudoDia.versiculoRef && <div style={{ fontSize: 13, fontWeight: "bold", color: "#c9a84c", marginBottom: 18 }}>— {conteudoDia.versiculoRef}</div>}

                      {conteudoDia.aplicacao && (
                        <>
                          <div style={{ fontSize: 11, letterSpacing: 2, textTransform: "uppercase", color: "#c9a84c", marginBottom: 8 }}>🙋 Aplicação Pessoal</div>
                      ...
                      {conteudoDia.sugestoes?.length > 0 && (
                        <>
                          <div style={{ fontSize: 11, letterSpacing: 2, textTransform: "uppercase", color: "#c9a84c", marginBottom: 8 }}>📚 Sugestão de Leitura</div>
                      ...
                      {conteudoDia.frase && (
                        <div style={{ marginTop: 18, padding: "14px 16px", border: "1px solid rgba(201,168,76,.25)", borderRadius: 12, textAlign: "center", fontSize: 13, fontStyle: "italic", color: "#c9a84c" }}>
                          "{conteudoDia.frase}"
                        </div>
                      )}

                      <button
                        style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6, width: "100%", marginTop: 18, background: "linear-gradient(90deg,#c9a84c,#e8c97a)", border: "none", borderRadius: 20, padding: "10px 16px", fontSize: 13, fontWeight: "bold", color: "#080810", cursor: "pointer", fontFamily: "Georgia,serif" }}
                        onClick={async () => {
              ...
              return (
                <div style={{ padding: "0 16px" }}>
                  ...
                  {leiturasSemanais.length === 0 ? (
                    ...
                    <div key={s.id} style={{ background: T.card, border: `1px solid ${editandoSemanaLeituraId === s.id ? "#c9a84c" : T.cardBorder}`, borderRadius: 12, padding: "12px 14px", marginBottom: 8 }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <div>
                        ...
                        <div style={{ display: "flex", gap: 6 }}>
                          <button onClick={() => {
                            ...
                            style={{ padding: "6px 10px", background: "rgba(201,168,76,.1)", border: "1px solid rgba(154,112,32,.5)", borderRadius: 8, color: "#8a6416", fontSize: 12, cursor: "pointer", fontFamily: "Georgia,serif" }}>✏️</button>
                      ...
                      {editandoSemanaLeituraId === s.id && (
                        <div style={{ marginTop: 14, paddingTop: 14, borderTop: `1px solid ${T.cardBorder}` }}>
                          <div style={{ display: "flex", gap: 6, overflowX: "auto", marginBottom: 14 }}>
                            {DIAS_SEMANA_LEITURA.map(d => (
                              <button key={d.id} onClick={() => {
                                ...
                                style={{ flexShrink: 0, padding: "7px 10px", borderRadius: 8, border: `1px solid ${diaEditandoLeitura === d.id ? "#c9a84c" : d.id === diaSemanaHojeLeitura() ? "#f59e0b" : T.cardBorder}`, background: diaEditandoLeitura === d.id ? "#c9a84c" : (s.dias?.[d.id] ? "rgba(34,197,94,.1)" : T.card), color: diaEditandoLeitura === d.id ? "#080810" : (s.dias?.[d.id] ? "#22c55e" : T.textSub), fontSize: 11, cursor: "pointer", fontFamily: "Georgia,serif", whiteSpace: "nowrap" }}>
                          ...
                          <button style={{ ...S.saveBtn, marginTop: 12, background: "linear-gradient(90deg,#c9a84c,#e8c97a)", color: "#080810" }}
              ...
              <div style={{ padding: "0 16px" }}>
                {membroSelecionado ? (
                  ...
                  <div>
                    {/* Seletor de view */}
                    <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
                      {[{ id: "lista", label: "👥 Membros" }, { id: "aniversariantes", label: "🎂 Aniversariantes" }, { id: "duplicados", label: "🔁 Duplicados" }, { id: "inativos", label: "🚫 Nunca Acessaram" }].map(v => (
      ...
      {showInstallBanner && (
        <div style={{ position: "fixed", bottom: "calc(90px + env(safe-area-inset-bottom, 0px))", left: "50%", transform: "translateX(-50%)", width: "calc(100% - 32px)", maxWidth: 400, background: "#040e20", border: `1px solid ${darkMode ? "rgba(201,168,76,.4)" : "rgba(154,112,32,.7)"}`, borderRadius: 16, padding: "16px 18px", zIndex: 998, boxShadow: "0 4px 24px rgba(0,0,0,.6)" }}>
