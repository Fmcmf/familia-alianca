...
const MINISTERIOS = [
  ...
  { id: 3, nome: "Ministério de Mídia", icon: "📸", desc: "Comunicando o evangelho com excelência através das redes sociais, transmissões ao vivo e produção audiovisual.", cor: "#06b6d4" },
...
const ESTUDOS_FIXOS = [
  ...
  },
  {
    ...
    perguntas: [
      ...
      "De que forma entender que a salvação é completamente pela graça — e não pelo seu esforço — muda sua relação com Deus?",
  ...
  },
  {
    ...
    perguntas: [
      ...
      "De que forma a certeza da sua salvação (capacete) influencia a forma como você enfrenta os ataques do inimigo contra sua mente?",
